...
auto length = function<1>([] (const auto& l)      { return length_(l); });
auto elem   = function<2>([] (auto&& x, const auto& l) { return elem_(x,l); });
auto null   = function<1>([] (const auto& l)      { return null_(l);   });
